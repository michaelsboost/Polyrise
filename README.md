...
✅ **Click/Tap to Add Elements** – Add blocks instantly to the page or as child elements.  
✅ **Click/Tap to Customize** – Modify text, styles, and layout effortlessly.  
✅ **Custom Components** – Create, save, and reuse components for faster workflows.  
✅ **Nested Elements** – Add elements inside other blocks for structured design.  
✅ **Command Palette** – Built-in **guide and command system** for quick actions.  
✅ **Keyboard Shortcuts** – Use `Ctrl`, `Shift`, and more for advanced interactions.  
✅ **Desktop Preview on Mobile** – View your website’s **desktop layout while designing on mobile.**  
...
✅ **Lightweight & Fast** – Designed for **performance and efficiency**.  
...
🔹 **Spread the Word** – Share Polyrise with fellow developers & creators.  
🔹 **Fork & Experiment** – Polyrise is yours to play with—have fun with it!
...
Your support helps keep Polyrise free, open-source, and constantly improving. 🚀
