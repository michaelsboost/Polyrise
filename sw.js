...
let filesToCache = [
  ...
  "./img/components/nav5.png",
  "./img/components/nav4.png",
  "./img/components/nav3.png",
  ...
  "./img/components/hero6.png",
  "./img/components/hero5.png",
  "./img/components/hero4.png",
  "./img/components/hero3.png",
  "./img/components/hero2.png",
  "./img/components/hero1.png",
  "./img/components/gridcentered.png",
  "./img/components/grid.png",
  "./img/components/gallery2.png",
  "./img/components/gallery.png",
  "./img/components/footer.png",
  "./img/components/follow.png",
  "./img/components/dialog3.png",
  "./img/components/dialog2.png",
  "./img/components/dialog1.png",
  "./img/components/custom.png",
  "./img/components/containercentered.png",
  "./img/components/container.png",
